...
class ZenCodingPlugin(gedit.Plugin):
    ...
    def activate(self, window):
        actions = [
          ('ZenCodingMenuAction',     None, '_Zen Coding',            None,            "Zen Coding framework",                                None),
          ('ZenCodingExpandAction',   None, '_Expand Zen Code',       '<Ctrl>E',        "Expand Zen code to raw HTML/CSS",                     self.expand_abbreviation),
          ('ZenCodingWrapAction',     None, '_Wrap with Zen Code...', '<Ctrl><Shift>E', "Wrap selection with HTML/CSS expanded from Zen code", self.wrap_with_abbreviation),
